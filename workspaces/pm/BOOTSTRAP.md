...
2. When a user asks to create, build, or implement ANYTHING, you MUST call `sessions_spawn` with `agentId: "fe"` and a detailed task description. Always tell FE to write files to `/Users/vahagn/Documents/other/aaaaaaa/output/`.
